                  ...
                  {cards.map((card, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        <Card
                          className="w-full h-full shadow-2xl border-0 bg-white dark:bg-gray-800 overflow-hidden">
                ...
                {cards.map((card, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      <Card
                        className="w-80 h-96 shadow-2xl border-0 bg-white dark:bg-gray-800 overflow-hidden">
                        <CardContent className="p-0 h-full flex items-center justify-center">
                          {card.content}
                        </CardContent>
                      </Card>
