...
export default function StatsCarouselCount({
  ...
  const [resetQueue, setResetQueue] = useState(new Set());
      ...
      <div className="relative h-[300px]">
        <AnimatePresence>
          {items.map((stat, index) => {
            ...
            const shouldShowZero = !isDragMode &&
            ...
            return (
              <motion.div
                ...
                whileDrag={isDragMode ? { scale: 0.95, cursor: "grabbing" } : {}}
                ...
                <div
                  ...
                  {shouldAutoAnimate ? (
                    ...
                    <StatsCarousel value={stat.value} suffix={stat.suffix} trigger={triggerCounter} />
                  ) : shouldShowZero ? (
                    <div className="text-5xl font-extrabold text-white dark:text-black">
                      0{stat.suffix}
                    </div>
                  ...
                  <p
                    className="text-xs text-neutral-400 dark:text-neutral-800 mt-2 text-center uppercase tracking-wide">
                    {stat.label}
                  </p>
                </div>
              </motion.div>
