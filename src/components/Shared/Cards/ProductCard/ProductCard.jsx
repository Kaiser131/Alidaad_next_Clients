  ...
  return (
    ...
    >
      <div className="aspect-square overflow-hidden">
        <p className="absolute top-3 right-2 bg-white px-4 z-10 rounded-xl font-[Caluxe] shadow-2xl">
          {product?.subCategory}
        </p>
        <img
          src={
            hovered && product.images[0] ? product.images[0] : product.images[1]
          }
          alt={product?.name}
          loading="lazy"
