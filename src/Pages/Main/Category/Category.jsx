...
const Category = () => {
    ...
    useHead({
        ...
        meta: [
            { name: 'description', content: `Browse ${category || 'products'} at AlIdaad` }
        ]
    });
    ...
    return (
        <div className='min-h-[70dvh] mt-20 md:mt-24 md:max-w-10/12 mx-auto px-4 sm:px-6 lg:px-8 border-t'>
            <h1 className='text-2xl sm:text-3xl md:text-4xl mb-3 sm:mb-4 mt-2'>{category}</h1>
            <div className='mb-4'>
                {/* <Breadcrumbs /> */}
            </div>
            ...
            <div>
                ...
                <div className="hidden md:flex items-center justify-between border-gray-200 text-sm text-gray-700 my-3">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <span className="text-gray-500">{categoryData?.length} products</span>
                    </div>
